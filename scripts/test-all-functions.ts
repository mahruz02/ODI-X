...
for (let d = 1; d <= 12; d++) {
  mockScores.push(
    { organization_id: "test", organization_name: "Test Org", dimension: d, role: "pengurus" as const, avg_score: 4.2, respondents: 5 },
    { organization_id: "test", organization_name: "Test Org", dimension: d, role: "manajemen" as const, avg_score: 3.8, respondents: 8 },
    { organization_id: "test", organization_name: "Test Org", dimension: d, role: "karyawan" as const, avg_score: 3.0, respondents: 20 },
    { organization_id: "test", organization_name: "Test Org", dimension: d, role: "stakeholder" as const, avg_score: 3.9, respondents: 10 }
  );
}
